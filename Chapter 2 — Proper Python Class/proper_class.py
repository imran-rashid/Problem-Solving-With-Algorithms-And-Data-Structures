...
class MSDie:
	...
	def __str__(self): return str(self.current_value)
	def __repr__(self): return f'MSDie({self.num_sides}) : {self.current_value}'

	def __lt__(self, other): return self.current_value < other.current_value
	def __le__(self, other): return self.current_value <= other.current_value
	def __eq__(self, other): return self.current_value == other.current_value

my_die = MSDie(6)
for i in range(5):
	print(my_die)

d_list = [MSDie(6), MSDie(10)]
print(d_list)